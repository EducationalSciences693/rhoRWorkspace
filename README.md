...
- `runtime.txt`, `install.R`, and `postBuild` These are used to specify the R environment that binder needs to prepare for our code to run
- `main.ipynb` This is where your code runs! It is a Jupyter notebook configured to use the [R](https://www.r-project.org/) programming language. It shows an example of loading a file (file not provided) and calculating IRR scores between two columns
...
1. Create a [copy of this template](https://github.com/EducationalSciences693/rhoRWorkspace/generate). It will need to be a public repo, but you can name it whatever you want
...
Last updated: 2021-12-08 03:24:10 PM UTC
